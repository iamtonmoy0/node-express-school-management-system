...
// controller
const { createExamController, getAllExamController, getExamByIdController, updateExamController } = require('../../../controllers/academic/exams.controller');
// teacher create exam
examRouter.route('/exams')
 .get(isLoggedIn,isTeacher,getAllExamController)
 .post(isLoggedIn,isTeacher,createExamController)
examRouter.route('/exams/:examId')
