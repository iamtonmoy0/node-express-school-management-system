...
//controllers
const { createTeacherController, teacherLoginController, getAllTeachersController, getTeacherProfileController, updateTeacherProfileController, adminUpdateTeacherProfileController } = require('../../../controllers/staff/teachers.controller');
// create teacher
...
teachersRouter.route('/teachers')
 ...
 // get teacher profile
teachersRouter.route('/teacher/:teacherId/profile')
...
teachersRouter.route('/teacher/:teachersId/update-profile')
